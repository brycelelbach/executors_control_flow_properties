...
#if !defined(EXECUTORS_CONTROL_FLOW_PROPERTIES_CUDA_MEMORY_HPP)
#define EXECUTORS_CONTROL_FLOW_PROPERTIES_CUDA_MEMORY_HPP
...
#endif // EXECUTORS_CONTROL_FLOW_PROPERTIES_CUDA_MEMORY_HPP
