...
#if !defined(EXECUTORS_CONTROL_FLOW_PROPERTIES_CUDA_EXECUTOR_HPP)
#define EXECUTORS_CONTROL_FLOW_PROPERTIES_CUDA_EXECUTOR_HPP
...
#endif // EXECUTORS_CONTROL_FLOW_PROPERTIES_CUDA_EXECUTOR_HPP
